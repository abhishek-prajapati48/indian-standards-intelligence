...
function Placeholder({title}){return <Layout><h1 className="text-3xl font-bold">{title}</h1>
<div className="mt-8 rounded-xl border bg-white p-8 text-slate-500">This module will be implemented in the upcoming phase.</div></Layout>}
